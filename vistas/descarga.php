...
if ($_GET["search"]!=""){ 
    ...
    $criterio = " where nombre_des like '%" . $txt_criterio . "%' "; 
...
if ($_GET["cat"]!="" && $_GET["search"]!="" ){ 
    $op1 = $_GET["cat"]; 
    $op2 = $_GET["search"]; 
    $criterio = " where  (categoria_idcate = ". $op1 .") and  (nombre_des like '%" .$op2. "%') "; 
   ...
   $pdo = conexion::connect();
    $sqlc="SELECT COUNT(*)   from descargas ".$criterio ;
...
<img src="../public/imagen/ban_1.jpg" alt="Nature" class="responsive" width="600" height="400">
      ...
      <nav class="site-navigation text-right text-md-center" role="navigation">
        <div class="container">
          <ul class="site-menu js-clone-nav d-none d-md-block">
            ...
            <li  class="active"><a href="descarga.php">Descargas</a></li>
  ...
  <?php include('../public/social/index.php') ?>
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
         <div class="col-md-12 mb-0"><a href="inicio.php">Inicio</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">descargas</strong></div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-9 order-2">
            <div class="row">
              <div class="col-md-12 mb-5">
                 <div class="float-md-left mb-4"><h2 class="text-black h5">Descargas nuestros archivos</h2></div>
              </div>
            </div>
            <div class="row mb-5">
                 <?php
   ...
   $sql = " select * from descargas ".$criterio." limit ".$inicio .",". $TAMANO_PAGINA ;
       ...
       foreach ($pdo->query($sql) as $row) {
                      ...
                      ?>
                            ...
                            <div class="course " id="idtexto" >
                              
                              <a href="detalle-descarga.php?id_tramite=<?php echo $row['id_des']; ?>" class="course-img">
                                    <img src="../admin/vistas/imagenes/<?php echo $row['url_descarga']; ?>" alt="" style="height: 170px;">
                                    <i class="course-link-icon fa fa-plus"></i>
                                       <?php if ($row['estado']==1) {
                                                                           echo '<img style="width: 130px;" class="flotante1" src="../public/imagen/oferta.png " />';
                                                                        } ?>
                                </a>
                                 <p style="font-size: 13px;color: #000;"><b> <?php echo $row['nombre_des']; ?></b></p>
    ...
    border: 1px solid #ccc;">'.$pagina.'</li>';  }
            ...
            //si el índice no corresponde con la página mostrada actualmente, coloco el enlace para ir a esa página
                if($total_paginas>10){
                   echo "<a href='descarga.php?pagina=" . $i . "'>" . $i . "</a> ";  }
                   else{
                 echo '<li><a href="descarga.php?pagina='.$i.'">'.$i.'</a></li>';  } 
          ...
          <div class="col-md-3 order-1 mb-5 ">
            <div class="border p-4 rounded mb-1" style="margin-top:100px;">
              ...
              <ul class="list-unstyled mb-0">
                <!--<li class="mb-1"><a href="#" class="d-flex"><span>descarga1</span> <span class="text-black ml-auto"></span></a></li>-->
                <a href="descarga.php" id="idbusca">TODO</a><br>
                  <?php
  
    $pdo = conexion::connect();
   $sql = "SELECT * FROM categoria where tipo_cat ='DESCARGAS' order by id_cat DESC ";
   $plus="";
   if(isset($_GET['search'])){
     $plus="&search=".$_GET['search'];
      ...
      foreach ($pdo->query($sql) as $row) { 
                      ?>
                  <a class="category" id="idbusca"href="descarga.php?cat=<?php echo $row['id_cat'].$plus; ?>"><?php echo $row['nombre_cat'] ; ?><br>  </a>
