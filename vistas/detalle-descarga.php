      ...
      $msg='';
        ...
        if(empty($imagen)){
           $imagen =$_POST['imant'];
            ...
            $imagenError = "Theme was a desblem uploading image";
        }
        ...
        if ($valid) {
            ...
            $sql = " UPDATE descargas set nombre_des = ?, descripcion = ?, texto_boton = ?, url_boton = ?, url_descarga=?,categoria_idcate =?  WHERE id_des = ?";
            $q = $pdo->prepare($sql);
            $q->execute(array($nom_tramite,$descripcion,$texto_boton,$url_boton,$idcate, $imagen, $id_tramite));
            conexion::disconnect();
            header("Location: listar.php");
        }
    } else {
...
<img src="../public/imagen/ban_2.jpg" alt="Nature" class="responsive" width="600" height="400">
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="inicio.php">Inicio</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Descripcion descarga</strong></div>
        </div>
      </div>
    </div>  
    <style type="text/css">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            ...
            <img src="../admin/vistas/imagenes/<?php echo $imagen;?>" alt="" style="width: 400px;height:350px; ">
          </div>
          <div class="col-md-6">
            ...
            <br/>
             ...
             <a href="admin/pdf/<?php echo $fchtecnica ?>"  target="_blank" class="buy-now btn btn-sm btn-primary">Manual de Instalación</a>
            <?php } ?>
            <?php if ($local_link == 1) {?>
            <a href="<?php  echo $url_boton; ?>" target="_blank" class="buy-now btn btn-sm btn-primary"> Descargar</a>
            <?php } else{?>
              <a href="<?php  echo $url_boton; ?>" target="_blank" class="buy-now btn btn-sm btn-primary"> Descargar</a>
            <?php } ?> <br/> <br/>
            <img src="../public/imagen/pago.png" class="responsive">
            <br/> <br/>
            <p><a href="https://api.whatsapp.com/send?phone=51985203000&text=Hola!%20Quiero%20mas%20informaci��n!" class="buy-now btn btn-sm btn-primary">Comprar</a></p>
          </div>
        </div>
      </div>
    </div>
